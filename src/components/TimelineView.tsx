          ...
          >
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 px-4 sm:px-6 py-4 border-b border-gray-200">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="space-y-1">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900">{app.position}</h3>
                  <p className="text-gray-600 font-medium text-sm sm:text-base">{app.company}</p>
                </div>
                {nextEvent && (
            ...
            <div className="px-3 sm:px-6 py-5">
              <div className="relative">
                {/* Timeline line */}
                <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-gray-200 sm:left-5"></div>
                          ...
                          <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:bg-gray-100 transition-colors">
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                              <div className="space-y-1">
                                ...
                                {event.notes && (
                                  <p className="text-xs sm:text-sm text-gray-700 italic">"{event.notes}"</p>
                                )}
                              </div>
            ...
            {/* Actions */}
            <div className="px-4 sm:px-6 py-4 bg-gray-50 border-t border-gray-200 flex flex-col gap-2 sm:flex-row sm:justify-end">
              {onEdit && (
                <button
                  onClick={() => onEdit(app)}
                  className="px-4 py-2 text-sm font-medium text-indigo-700 bg-indigo-100 hover:bg-indigo-200 rounded-lg transition"
                >
                  Edit
                </button>
              )}
